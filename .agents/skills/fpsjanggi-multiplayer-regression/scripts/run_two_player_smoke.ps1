...
$testFlag = if ($ReturnLobby) { '-ReturnLobbySmokeTest' } elseif ($General) { '-GeneralSmokeTest' } elseif ($Arena) { '-ArenaSmokeTest' } else { '-BoardSmokeTest' }
